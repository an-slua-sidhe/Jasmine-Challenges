describe("My whatCanIDrink function", function () {
    ...
    describe("Checks age", function () {
        ...
        it("should return drink tanora when called as whatCanIDrink(13)", function () {
            var result = whatCanIDrink(13)
            expect(result).toBe("Drink Tanora");
        });
        ...
        it("should return drink hist sap when called as whatCanIDrink(30)", function () {
            var result = whatCanIDrink(30)
            expect(result).toBe("Drink Hist Sap");
        });

        it("should be unable to return a drink when called as whatCanIDrink(140)", function () {
            var result = whatCanIDrink(140)
            expect(result).toBe("Sorry. I can't tell you what drink to have because that age doesn't make sense! :-)");
        });
